...
class MLTModel(object):
    ...
    def create_input_dictionary_for_batch(self, batch, y_batch, is_training, learningrate):
        ...
        sentence_labels = y_batch.astype(numpy.float32)
    ...
    def process_batch(self, batch, y_batch, is_training, learningrate):
        feed_dict = self.create_input_dictionary_for_batch(batch, y_batch, is_training, learningrate)
